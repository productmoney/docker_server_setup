...
echo "wget -q -O \"$HOME/.zsh_aliases\" \"$REPO_LOC/.zsh_aliases\" ~/.zsh_aliases"
wget -q -O "$HOME/.zsh_aliases" "$REPO_LOC/.zsh_aliases" ~/.zsh_aliases

echo "wget -q -O \"\$HOME/.zshrc\" \"$REPO_LOC/.zshrc\" ~/.zshrc"
wget -q -O "$HOME/.zshrc" "$REPO_LOC/.zshrc" ~/.zshrc
